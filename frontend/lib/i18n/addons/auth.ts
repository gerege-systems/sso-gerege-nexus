...
export const auth = {
  ...
  "auth.view.lede": {
    mn: "eID Mongolia апп дээр хүсэлтийг зөвшөөрөхөд Gerege SSO болон холбогдсон SSO аппууд таны баталгаажсан session-ийг ашиглана.",
    en: "Approve the request in the eID Mongolia app and Gerege SSO — along with every connected SSO app — uses that verified session.",
  },
  ...
  "auth.message.error_link": {
    mn: "eID баталгаажуулалтыг Gerege SSO хэрэглэгчтэй холбож чадсангүй",
    en: "The eID verification could not be linked to a Gerege SSO user",
  },
