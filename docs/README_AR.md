...
**منصة الدخول الموحّد وإدارة الهوية والوصول**

**Gerege SSO** منصة مفتوحة المصدر مبنية على
[Gerege Nexus](https://github.com/gerege-systems/open-gerege-nexus)، توحّد
المستخدمين والمصادقة والصلاحيات والوصول إلى الأنظمة عبر المؤسسات العامة
والخاصة. تضع اللغة **المنغولية في المقام الأول**، وتتكامل مباشرة مع البنية
التحتية الرقمية الوطنية في منغوليا (DAN و E-ID و XYP / ХУР).

يتحقق المواطن أو الموظف **مرة واحدة** عبر هويته الرقمية الوطنية، ثم يصل إلى كل
تطبيق يحق له استخدامه دون تسجيل دخول جديد. وتتصل الأنظمة الخارجية بهذه الجلسة
عبر OAuth2 / OIDC بدلاً من الاحتفاظ بمخازن كلمات مرور خاصة بها.

كلمة *Nexus* تعني نقطة الاتصال: حيث تلتقي المؤسسات والخدمات وسير العمل والأنظمة
والمستخدمون والبيانات. و Gerege SSO هي **طبقة الهوية والوصول** في هذا الاتصال:
تُثبت هوية الشخص وتقرر ما يُسمح له بالوصول إليه. والوحدات التي تعمل فوقها هي ما
يحدد طبيعة كل عملية نشر.
...
- **تأكيد البريد الإلكتروني** (`platform/emailverify`) — مسار موحَّد لإثبات ملكية
