...
**Нэгдсэн нэвтрэлт, ялгах танилт, хандалтын удирдлагын платформ**

**Gerege SSO** нь [Gerege Nexus](https://github.com/gerege-systems/open-gerege-nexus)
дээр суурилсан, төрийн болон хувийн хэвшлийн байгууллагын хэрэглэгч, нэвтрэлт,
эрх, системийн хандалтыг нэг дор удирдах платформ юм. Cloud-native экосистемээс
санаа авсан, өндөр бүтээмжтэй, Монгол Улсын цахим дэд бүтэц (ДАН, E-ID,
ХУР / XYP)-тэй шууд холбогдох боломжтой, **монгол хэлийг үндсэн хэл болгосон**
нээлттэй эхийн шийдэл.

Иргэн эсвэл ажилтан үндэсний цахим үнэмлэхээрээ **нэг удаа** баталгаажаад, эрх
олгогдсон бүх апп, үйлчилгээндээ дахин нэвтрэхгүйгээр орно. Гуравдагч системүүд
OAuth2 / OIDC стандартаар энэ нэвтрэлтэд холбогдож, өөрсдийн нууц үгийн санг
тусад нь авч явах шаардлагагүй болно.

*Nexus* гэдэг нь холбох цэг — байгууллага, үйлчилгээ, ажлын урсгал, систем,
хэрэглэгч, өгөгдөл нэг дор уулзах цэгийг хэлнэ. Gerege SSO бол тэрхүү холболтын
**нэвтрэлт, эрхийн давхарга**: хэн болохыг баталгаажуулж, юунд хандах эрхтэйг
шийднэ. Дээр нь ажиллах модулиуд л тухайн байгууллагын хэрэгцээг тодорхойлно.
